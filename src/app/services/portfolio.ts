...
const portfolioData: PortfolioData = {
  ...
  idols: [
    ...
    },
    {
      number: '02',
      name: 'Julius Caesar',
      role: 'Roman General & Dictator',
      category: 'historical',
      reason: 'Caesar inspires me because of his ambition, decisiveness, and ability to turn impossible situations into victories. He reshaped an entire civilization through sheer willpower and strategic brilliance.',
      imageUrl: '',
      copyright: '',
    },
    {
      ...
      role: 'King of Macedonia & Conqueror',
      category: 'historical',
      reason: 'Alexander inspires me because he achieved the unthinkable before the age of 30. His vision, leadership, and refusal to accept limits remind me that age is never an excuse to think small.',
      imageUrl: '',
      copyright: '',
    },
    {
